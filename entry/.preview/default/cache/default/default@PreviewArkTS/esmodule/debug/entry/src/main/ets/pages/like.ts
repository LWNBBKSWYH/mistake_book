...
class CollectionPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/like.ets(126:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 标题栏
            Row.create({ space: 5 });
            Row.debugLine("entry/src/main/ets/pages/like.ets(128:7)", "entry");
            // 标题栏
            Row.width('100%');
            // 标题栏
            Row.height(56);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/like.ets(129:9)", "entry");
            Image.width(30);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create("我的收藏");
            Text.debugLine("entry/src/main/ets/pages/like.ets(134:9)", "entry");
            Text.fontSize(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/like.ets(139:9)", "entry");
        }, Blank);
        Blank.pop();
        // 标题栏
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 搜索栏
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/like.ets(149:7)", "entry");
            // 搜索栏
            Row.width('100%');
            // 搜索栏
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Search.debugLine("entry/src/main/ets/pages/like.ets(150:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.searchValue !== '') {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": 16777236, "type": 20000, params: [], "bundleName": "com.example.errorbook", "moduleName": "entry" });
                        Image.debugLine("entry/src/main/ets/pages/like.ets(165:11)", "entry");
                        Image.width(20);
                        Image.margin({ left: 5 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.searchHistory.length > 0 && this.searchValue === '') {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/like.ets(176:9)", "entry");
                        Column.width('100%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/pages/like.ets(177:11)", "entry");
                        Row.width('100%');
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('搜索历史');
                        Text.debugLine("entry/src/main/ets/pages/like.ets(178:13)", "entry");
                        Text.fontSize(16);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // 新增：清空所有历史按钮
                        Text.create('清空');
                        Text.debugLine("entry/src/main/ets/pages/like.ets(186:13)", "entry");
                        // 新增：清空所有历史按钮
                        Text.fontSize(14);
                        // 新增：清空所有历史按钮
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Flex.debugLine("entry/src/main/ets/pages/like.ets(194:11)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        const forEachItemGenFunction = _item => {
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create();
                                Row.debugLine("entry/src/main/ets/pages/like.ets(196:15)", "entry");
                            }, Row);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create(item);
                                Text.debugLine("entry/src/main/ets/pages/like.ets(197:17)", "entry");
                                Text.fontSize(14);
                                Text.padding(8);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                // 新增：删除单个历史项按钮
                                Image.create({ "id": 16777222, "type": 20000, params: [], "bundleName": "com.example.errorbook", "moduleName": "entry" });
                                Image.debugLine("entry/src/main/ets/pages/like.ets(207:17)", "entry");
                                // 新增：删除单个历史项按钮
                                Image.width(12);
                                // 新增：删除单个历史项按钮
                                Image.margin({ left: -8 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            List.debugLine("entry/src/main/ets/pages/like.ets(225:7)", "entry");
            // 收藏列表
            List.width('100%');
            // 收藏列表
            List.layoutWeight(1);
                ...
                this.ifElseBranchUpdateFunction(0, () => {
                    {
                        ...
                        const itemCreation2 = (elmtId, isInitialRender) => {
                            ...
                            ListItem.debugLine("entry/src/main/ets/pages/like.ets(227:11)", "entry");
                        };
                        const deepRenderFunction = (elmtId, isInitialRender) => {
                            itemCreation(elmtId, isInitialRender);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Column.create();
                                Column.debugLine("entry/src/main/ets/pages/like.ets(228:13)", "entry");
                                Column.width('100%');
                                Column.height(200);
                                Column.justifyContent(FlexAlign.Center);
                            }, Column);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Image.create({ "id": 16777234, "type": 20000, params: [], "bundleName": "com.example.errorbook", "moduleName": "entry" });
                                Image.debugLine("entry/src/main/ets/pages/like.ets(229:15)", "entry");
                                Image.width(100);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Text.debugLine("entry/src/main/ets/pages/like.ets(233:15)", "entry");
                                Text.fontSize(18);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        const forEachItemGenFunction = _item => {
                            const item = _item;
                            {
                                ...
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ListItem.create(deepRenderFunction, true);
                                    ListItem.debugLine("entry/src/main/ets/pages/like.ets(243:13)", "entry");
                                };
                                const deepRenderFunction = (elmtId, isInitialRender) => {
                                    itemCreation(elmtId, isInitialRender);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Column.create({ space: 8 });
                                        Column.debugLine("entry/src/main/ets/pages/like.ets(244:15)", "entry");
                                        Column.padding(15);
                                        Column.width('100%');
                                        Column.backgroundColor('#FFFFFF');
                                        Column.borderRadius(10);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Row.create();
                                        Row.debugLine("entry/src/main/ets/pages/like.ets(245:17)", "entry");
                                        Row.width('100%');
                                    }, Row);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Text.create(item.title);
                                        Text.debugLine("entry/src/main/ets/pages/like.ets(246:19)", "entry");
                                        Text.fontSize(18);
                                        Text.fontWeight(FontWeight.Medium);
                                        Text.maxLines(1);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Image.create({ "id": 16777222, "type": 20000, params: [], "bundleName": "com.example.errorbook", "moduleName": "entry" });
                                        Image.debugLine("entry/src/main/ets/pages/like.ets(254:19)", "entry");
                                        Image.width(25);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Row.create({ space: 10 });
                                        Row.debugLine("entry/src/main/ets/pages/like.ets(260:17)", "entry");
                                        Row.width('100%');
                                        Row.margin({ top: 5 });
                                    }, Row);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Text.create(`科目：${item.subject}`);
                                        Text.debugLine("entry/src/main/ets/pages/like.ets(261:19)", "entry");
                                        Text.fontSize(14);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Text.debugLine("entry/src/main/ets/pages/like.ets(265:19)", "entry");
                                        Text.fontSize(14);
                                        Text.fontColor('#666666');
                                    }, Text);
                                    Text.pop();
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Text.debugLine("entry/src/main/ets/pages/like.ets(272:17)", "entry");
                                        Text.fontSize(12);
                                        Text.fontColor('#999999');
                                        Text.margin({ top: 5 });
